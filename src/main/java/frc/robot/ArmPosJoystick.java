...
public class ArmPosJoystick extends WPIJoystick {
    ...
    public static enum Ids implements IJoystickButtonId {
        ...
        HOME(null, Logitech.b, null, homePos, RobotPos.FIELD,
                RobotOrientation.FORWARD),
        LOADING_ZONE_FORWARD_CUBE(null, reverse, Logitech.x, new Vector2(0.474, 0.89), RobotPos.LOADING_ZONE,
                RobotOrientation.FORWARD),
        LOADING_ZONE_FORWARD_CONE(null, reverse, Logitech.y, new Vector2(0.51, 0.94), RobotPos.LOADING_ZONE,
                RobotOrientation.FORWARD),
        LOADING_ZONE_REVERSE_CUBE(null, forward, Logitech.x, new Vector2(-0.781, 1.00), RobotPos.LOADING_ZONE,
                RobotOrientation.REVERSE),
        LOADING_ZONE_REVERSE_CONE(null, forward, Logitech.y, new Vector2(-0.817, 1.1), RobotPos.LOADING_ZONE,
                RobotOrientation.REVERSE),
